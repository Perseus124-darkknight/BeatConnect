...
import { addArtist } from '../../services/db';
...
export default function AddArtistScreen() {
  ...
  const handleSubmit = async () => {
    if (!name || !genres || !songs || !image) {
      Alert.alert('Error', 'Please fill in all fields (Artist Name, Genres, Songs, Image URL)');
      return;
    }
  ...
  return (
    ...
    >
      ...
      <View className="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] bg-purple-900/20 rounded-full blur-[120px]" />
      ...
      <View className="px-6 pt-16 pb-4 flex-row items-center z-10">
        ...
        <View>
          ...
          <Text className="text-white text-2xl font-black tracking-tight">Add New Artist</Text>
        </View>
      </View>
      ...
      <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        <View className="bg-zinc-900/60 border border-white/5 rounded-[32px] p-6 shadow-black/50 shadow-2xl mt-4">
          ...
          <View className="mb-6">
            ...
            <View className="flex-row items-center bg-black/40 border border-white/10 rounded-2xl px-4 h-14 focus:border-purple-500/50">
          ...
          <View className="mb-6">
            ...
            <View className="flex-row items-center bg-black/40 border border-white/10 rounded-2xl px-4 h-14 focus:border-purple-500/50">
              ...
              <TextInput
                className="flex-1 text-white ml-3 h-full font-medium"
                placeholder="e.g. R&B, Pop, Synthwave"
                placeholderTextColor="#52525b"
                value={genres}
          ...
          <View className="mb-6">
            ...
            <View className="bg-black/40 border border-white/10 rounded-2xl px-4 py-4 focus:border-purple-500/50">
              <TextInput
          ...
          <View className="mb-8">
              ...
              {image ? (
                ...
                <View className="py-6 items-center">
                  ...
                  <TouchableOpacity 
                    ...
                    className="bg-purple-600/20 border border-purple-500/30 rounded-xl px-6 py-3 flex-row items-center"
                  >
                    {isUploadingImage ? <ActivityIndicator color="#a855f7" size="small" /> : (
                      <>
                        <Ionicons name="cloud-upload-outline" size={20} color="#c084fc" />
                        <Text className="text-purple-300 font-bold ml-2">Browse Files</Text>
                      </>
                    )}
                  </TouchableOpacity>
                </View>
            ...
            <View className="flex-row items-center bg-black/40 border border-white/10 rounded-2xl px-4 h-14 mt-4 focus:border-purple-500/50">
              <Ionicons name="link-outline" size={20} color="#71717a" />
              <TextInput
                className="flex-1 text-purple-300 ml-3 h-full font-medium"
          ...
          <TouchableOpacity 
            ...
            className={`w-full ${isSubmitting ? 'bg-purple-800' : 'bg-purple-600'} rounded-2xl py-4 flex-row justify-center items-center shadow-lg shadow-purple-600/40`}
          >
            ...
            <Text className="text-white font-black tracking-widest text-lg">
              {isSubmitting ? 'PUBLISHING...' : 'PUBLISH ARTIST'}
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
